...
```sql
-- Phase state (single row, updated in place)
CREATE TABLE phase (
    id INTEGER PRIMARY KEY DEFAULT 1,
    current_phase TEXT NOT NULL DEFAULT 'pre_storm',  -- pre_storm, active_storm, post_storm
    started_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

-- Risk assessments per neighborhood
CREATE TABLE risk_assessments (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    neighborhood TEXT NOT NULL,
    zone TEXT,                    -- evacuation zone A, B, C
    lat REAL NOT NULL,
    lng REAL NOT NULL,
    flood_risk REAL,             -- 0.0 to 1.0
    storm_surge_ft REAL,
    time_to_impact_hours REAL,
    recommendation TEXT,         -- evacuate, shelter_in_place, monitor
    evacuate_by TIMESTAMP,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

-- Alerts generated by Alert Agent
CREATE TABLE alerts (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    phase TEXT NOT NULL,
    priority TEXT NOT NULL,      -- info, warning, critical, emergency
    neighborhood TEXT,
    title TEXT NOT NULL,
    message TEXT NOT NULL,
    message_es TEXT,             -- Spanish translation
    channels TEXT,               -- JSON array: ["app", "sms", "voice"]
...
CREATE TABLE reports (
    ...
    source TEXT NOT NULL,        -- sms, app, partner
    sender_phone TEXT,
    location_text TEXT,
    lat REAL,
    lng REAL,
    incident_type TEXT,          -- flooding, structural_damage, trapped_person, etc.
    people_mentioned INTEGER,
    has_children INTEGER DEFAULT 0,
    language TEXT DEFAULT 'en',
    processed INTEGER DEFAULT 0, -- has Field Report Agent parsed this?
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

-- Severity-ranked incidents (consolidated from reports)
CREATE TABLE incidents (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    report_ids TEXT,             -- JSON array of report IDs
    ...
    factors TEXT,               -- JSON array of severity factors
...
-- Resources (shelters, supplies, etc.)
CREATE TABLE resources (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    type TEXT NOT NULL,          -- shelter, medical, supply_point, charging, road
    name TEXT NOT NULL,
    lat REAL NOT NULL,
    lng REAL NOT NULL,
    address TEXT,
    ...
    status TEXT DEFAULT 'open', -- open, full, closed, damaged
    notes TEXT,
...
CREATE TABLE missing_persons (
    ...
    status TEXT DEFAULT 'missing', -- missing, found, confirmed_safe
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

-- Found / shelter check-in records
CREATE TABLE found_persons (
    ...
    gender TEXT,
    description TEXT,
    found_at TEXT,              -- shelter name or location
    found_lat REAL,
    found_lng REAL,
    checked_in TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    matched_missing_id INTEGER, -- FK to missing_persons if matched
...
CREATE TABLE matches (
    ...
    match_factors TEXT,         -- JSON array of reasons
...
-- Recovery briefs (generated by Gemini)
CREATE TABLE recovery_briefs (
    ...
    water_status TEXT,
    roads_status TEXT,
    shelters_nearby TEXT,       -- JSON
    medical_nearby TEXT,        -- JSON
    key_updates TEXT,           -- JSON array of bullet points
